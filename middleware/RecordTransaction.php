...
namespace Octobro\ElasticApm\Middleware;
...
class RecordTransaction
{
    ...
    public function __construct(Agent $agent, RequestStartTime $start_time)
    {
        $this->agent = $agent;
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (config('octobro-elastic-apm.transactions.useRouteUri')) {

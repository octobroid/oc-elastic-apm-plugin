...
use Octobro\ElasticApm\EventClock;
...
abstract class EventDataCollector implements DataCollector
{
    ...
    final public function __construct(Application $app, RequestStartTime $start_time, EventCounter $event_counter, EventClock $event_clock)
    {
        $this->app = $app;
    ...
    {
        $pattern = config('octobro-elastic-apm.transactions.ignorePatterns');

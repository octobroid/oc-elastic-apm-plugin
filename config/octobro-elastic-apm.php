...
//         'hostname'              => env('ELASTIC_APM_HOSTNAME'),
//         'serviceName'           => env('ELASTIC_APM_SERVICE_NAME', 'PLN Mobile API Internal'),
//         'serviceVersion'        => env('ELASTIC_APM_SERVICE_VERSION'),
//         'frameworkName'         => env('ELASTIC_APM_FRAMEWORK_NAME'),
//         'frameworkVersion'      => env('ELASTIC_APM_FRAMEWORK_VERSION'),
//         'enabled'               => env('ELASTIC_APM_ENABLED'),
//         'timeout'               => env('ELASTIC_APM_TIMEOUT'),
//         'environment'           => env('ELASTIC_APM_ENVIRONMENT'),
//         'stackTraceLimit'       => env('ELASTIC_APM_STACK_TRACE_LIMIT'),
//         'transactionSampleRate' => env('ELASTIC_APM_TRANSACTION_SAMPLE_RATE'),

//         'active'                => ['name' => 'enabled', 'default' => env('ELASTIC_APM_ACTIVE', true)],
//         'appName'               => ['name' => 'serviceName', 'default' => env('ELASTIC_APM_APP_NAME')],
//         'appVersion'            => ['name' => 'serviceVersion', 'default' => env('ELASTIC_APM_APP_VERSION')],
//         'backtraceLimit'        => ['name' => 'stackTraceLimit', 'default' => env('ELASTIC_APM_BACK_TRACE_LIMIT', 50)],
//     ]
// ];
